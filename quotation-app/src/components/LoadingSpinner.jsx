...
const LoadingSpinner = ({ message = 'Loading Database & Templates...', subtext = 'Please wait a moment' }) => {
  return (
    <div className="flex flex-col items-center justify-center p-8 sm:p-12 w-full min-h-[300px] font-sans">
